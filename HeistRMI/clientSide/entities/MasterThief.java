...
public class MasterThief extends Thread{
     ...
     */
    public MasterThief(String name, MasterThiefCCSStub cc_site, OrdinaryThiefCSStub c_site, AssaultPartyStub[] parties, MuseumStub museum, GeneralRepoStub gp){
        super(name);
        this.cc_site = cc_site;
        this.c_site = c_site;
        this.MT_state = MasterStates.PLANNING_THE_HEIST;
        this.museum = museum;
        isOver = false;
