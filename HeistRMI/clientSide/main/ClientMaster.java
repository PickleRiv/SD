...
/**
 *  Client side of the Heist to the Museum problem (master thief).
 *
...
public class ClientMaster {
	...
	public static void main(String[] args) {
		...
		//Name of the platforms where collection and concentration sites and museum servers are located
		...
		int ccServerPortNumb = -1, conServerPortNumb = -1,museumServerPortNumb = -1,apServerPortNumb = -1, genRepoServerPortNumb = -1;
		...
		master = new MasterThief("Master", ccSiteStub, conSiteStub, museumStub, aPartyStub,genReposStub);
